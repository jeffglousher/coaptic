...
External-reviewer brief (what the crate is, six areas, done vs deferred vs not planned, 0.1 API freeze, how to check): [`REVIEW.md`](../REVIEW.md). Caller contract: [`CALLER.md`](../CALLER.md).
