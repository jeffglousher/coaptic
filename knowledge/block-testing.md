...
Locked (Jeff, 2026-09-04). Policy. An in-crate harness is not on this tree; mapping and TDs: [Plugtest](/plugtest/index.md). Protocol behavior stays in [RFC 7959](/rfcs/rfc7959.md) and [RFC 9177](/rfcs/rfc9177.md). Slot defaults: [Memory](/memory.md). Profile numbers: [Profiles](/profiles.md).
