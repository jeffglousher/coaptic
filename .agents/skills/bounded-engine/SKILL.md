...
- Default datagram slot is **1472** bytes (IPv4 UDP max on Ethernet). RFC 7252 §4.6 1152 is `profiles::Constrained`, not the crate default. Body slot default is **4096** = 4 × 1024; **0** body slots and/or **0** body bytes is valid. Block/Q-Block test sweep: [Block testing](../../../knowledge/block-testing.md).
